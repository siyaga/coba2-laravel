    ...
    <div class="card-body text-center">
      ...
      <p>
        <small class="text-muted">
            By. <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decoration-none"\>{{ $posts[0]->author->name }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}</p></small>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p>
                    <small class="text-muted">
                        By. <a href="/posts?author={{ $post->author->username }}" class="text-decoration-none"\>{{ $posts[0]->author->name }}</a> {{ $post->created_at->diffForHumans() }}</p></small>
